        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <select
              ...
              onChange={(e) =>
                setForm((f) => ({
                  ...
                  is_incident: e.target.value === 'incidente_operativo' ? true : f.is_incident,
                }))
              }
              required
          ...
          <div className="flex items-center gap-3 py-1">
            <input
              type="checkbox"
              id="is_incident"
              checked={form.is_incident || form.event_type === 'incidente_operativo'}
              disabled={form.event_type === 'incidente_operativo'}
            ...
            />
            <label htmlFor="is_incident" className={`text-sm font-medium text-slate-700 select-none cursor-pointer ${form.event_type === 'incidente_operativo' ? 'opacity-70 cursor-not-allowed' : ''}`}>
              ¿Es un incidente operativo?
              {form.event_type === 'incidente_operativo' && (
                <span className="ml-1 text-xs font-normal text-slate-400">(automático)</span>
              )}
            </label>
          </div>
