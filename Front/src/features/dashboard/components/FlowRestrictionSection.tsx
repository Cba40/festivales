...
export function FlowRestrictionSection() {
  ...
  return (
    <>
      ...
      <div className="mb-4 p-3 bg-sky-50 border border-sky-200 rounded-lg text-sm text-sky-700">
        Aplica a TODAS las zonas del tipo durante la fase. Para cerrar UNA zona puntual, creá un Evento Imprevisto con impacto -100 en esa zona.
      </div>
