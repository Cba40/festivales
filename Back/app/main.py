...
app.include_router(operational_profiles_router)
app.include_router(operational_phases_router)
app.include_router(zone_behaviors_router)
app.include_router(operational_events_router)
app.include_router(operational_event_modifiers_router)
