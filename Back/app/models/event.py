...
class Event(Base):
    ...
    reference_point_latitude: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    reference_point_longitude: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
