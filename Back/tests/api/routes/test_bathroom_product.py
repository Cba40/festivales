"""Tests for the GET /api/events/{event_id}/products/bathroom endpoint.
...
from app.schemas.product import BathroomRecommendationResponse, ZonaSanitaryItem
...
class TestBathroomProductEndpoint:
    def test_200_ok(
        self,
        client: TestClient,
        ...
        assert first["referencia"] == "Entrada principal"
    ...
    def test_empty_zones(
        ...
        _mock_adapter.return_value = BathroomRecommendationResponse(
            event_id=EVENT_ID,
