...
from app.schemas.product import HydrationRecommendationResponse, ZonaHidratacionItem
...
def _mock_adapter(
    ...
    with patch(
        "app.api.routes.hydration.get_hydration_product_adapter",
        new_callable=AsyncMock,
    ) as mock:
        mock.return_value = HydrationRecommendationResponse(
            event_id=EVENT_ID,
            ...
            zonas=[
                ZonaHidratacionItem(
                    ...
                    lat=-30.95,
                    lng=-64.07,
                    referencia="Sector de hidratación",
                    distancia_min=3,
                ),
                ZonaHidratacionItem(
                    zone_id=str(ZONE_B),
...
class TestHydrationProductEndpoint:
    def test_200_ok(
        self,
        client: TestClient,
        ...
        assert first["referencia"] == "Sector de hidratación"
    ...
    def test_empty_zones(
        ...
        _mock_adapter.return_value = HydrationRecommendationResponse(
            event_id=EVENT_ID,
