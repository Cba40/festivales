...
def prediction_to_domain(model: PredictionModel) -> TerritorialPrediction:
    ...
    km_version_id = UUID(model.knowledge_model_version_id) if model.knowledge_model_version_id is not None and isinstance(model.knowledge_model_version_id, str) else None
    return TerritorialPrediction(
        ...
        knowledge_model_version_id=km_version_id,
    )
...
def prediction_to_model(entity: TerritorialPrediction) -> PredictionModel:
    return PredictionModel(
        ...
        knowledge_model_version_id=str(entity.knowledge_model_version_id) if entity.knowledge_model_version_id is not None else None,
